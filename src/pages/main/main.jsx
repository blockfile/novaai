                        ...
                        <div className="relative z-10  justify-center items-center h-full">
                                ...
                                <div className="flex justify-center">
                                    <div class="md:w-1/2 text-justify text-white  z-10  drop-shadow-md">
                                        <p className=" indent-6 md:tracking-widest ">
                                            VIRUS TOKEN IS NON-TRADABLE UNLESS
                                            YOU POSSESS AT LEAST
                                            <span className="">
                                                {" "}
                                                <i>TWO VIRUS TOKENS</i>.
                                            </span>{" "}
                                            THIS TOKEN FEATURES AN AUTOMATIC
                                            BURN MECHANISM, A REFERRAL FEE
                                            SYSTEM, AND A COINBACK REWARD. WITH
                                            EVERY BUY/SELL OPERATION, A 1% BURN
                                            FEE IS APPLIED TO THE TOTAL
                                            TRANSACTION VALUE.
                                            <em>
                                                <span className="">
                                                    {" "}
                                                    <i>
                                                        ...
                                                        YOU SELL, YOU RECEIVE A
                                                        COINBACK EQUAL TO 1% OF
                            ...
                            <section id="description">
                                ...
                                <div className="flex justify-center">
                                    <div class="md:w-1/2 text-justify text-white  z-10  drop-shadow-md">
                                        <p className=" indent-6 md:tracking-widest ">
                                            EARNING A REFERRAL FEE REQUIRES YOU
                                            TO PROVIDE AT LEAST{" "}
                                            <span className="">
                                                <i>TWO VIRUS TOKENS</i>
                                            </span>{" "}
                                            ...
                                            PURCHASE OR SALE THEY COMPLETE,
                                            YOU'RE ENTITLED TO 1% OF THOSE
                                            TRANSACTIONS.
                                            <i>
                                                AS AN EXAMPLE, IF PERSON 1
                                                ALLOWS PERSON 2 TO PURCHASE
                                                VIRUS TOKENS BY GIVING THEM A
                                                TOKEN, ANY BUY OR SELL ACTIVITY
                                                INVOLVING VIRUS TOKENS BY PERSON
                                                2 WILL RESULT IN A 1% COMMISSION
                                                FOR PERSON 1. THIS COMMISSION IS
                                                PAID OUT IN{" "}
                                                <span className="">
                                                    NATIVE VIRUS TOKENS AND WILL
                                                    UPDATE IN PERSON 1’S BALANCE
                                                    FOLLOWING THE SALE OF TOKENS
                                                    BY PERSON 2.
                                                </span>
                                            </i>
                                        </p>
